...
const Header = () => {
    ...
    useEffect(() => {
        console.log("Header=");
        setCountItems(0);
        setCountItems(Object.keys(basket).reduce((acc, el) => acc + basket[el], 0));
        console.log("Header=", countItems);
    }, [basket, countItems]);
        ...
        <header>
            <div className="header center">
                <div className="header_left">
                    <Link className="menu_basket" to={'/'}>
                        <img src={logo} alt="logo" />
                    </Link>
                    <a className="menu_find" href="#"><svg className="header_menu__svg" xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="header_right">
                    <div className="menu-burger-icon">
                        <label htmlFor="burger"><svg className="header_menu__svg" xmlns="http://www.w3.org/2000/svg" width="32"
                    ...
                    <Link className="menu_person" to={'/registration'}>
                        <svg className="header_menu__svg" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <Link className="menu_basket" to={'/basket'}>

                        <svg className="header_menu__svg"
                        ...
                        {countItems && <Badge badgeContent={countItems} />}
                    </Link>
                </div>
            </div>
        </header>
